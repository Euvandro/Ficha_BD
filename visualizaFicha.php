...
<button type="submit" name="id_ficha" class="btn btn-outline-success btn-lg p-3" value="<?= $id_ficha ?>">Salvar Ficha</button>
        <form action="php/apagarFicha.php" method="post">
            <button type="submit" name="id_ficha" class="btn btn-outline-danger btn-lg p-3" value="<?= $id_ficha ?>">Apagar Ficha</button>
        </form>
</form>
</main>
