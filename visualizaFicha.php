    ...
    <div class="col-lg-12">
        <div id="area-habilidades">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    <td>
                        <select name="habilidades[]" class="custom-select" onchange="carregaDadosHabilidade(this)">
...
<button type="submit" name="id_ficha" class="btn btn-outline-success btn-lg p-3" value="<?= $id_ficha ?>">Salvar Ficha</button>
    ...
    <form action="php/apagarFicha.php" method="post" class="mt-3 mb-3">
        <input type="hidden" value="<?= $linha['id_status'] ?>" name="id_status">
        <input type="hidden" value="<?= $linha['id_atributos'] ?>" name="id_atributos">
        <button type="submit" name="id_ficha" class="btn btn-outline-danger p-3" value="<?= $id_ficha ?>">Apagar Ficha</button>
    </form>
</main>
